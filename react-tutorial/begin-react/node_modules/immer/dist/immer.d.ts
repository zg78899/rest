...
export declare class Immer implements ProducersFns {
    ...
    /** @internal */
    processResult(result: any, scope: ImmerScope): any;
    /**
     * @internal
     * Finalize a draft, returning either the unmodified base state or a modified
     * copy of the base state.
     */
    finalize(draft: any, path: string[] | null, scope: ImmerScope): any;
    /**
     * @internal
     * Finalize all drafts in the given state tree.
     */
    finalizeTree(root: any, rootPath: string[] | null, scope: ImmerScope): any;
    maybeFreeze(value: any, deep?: boolean): void;
}
export {};
