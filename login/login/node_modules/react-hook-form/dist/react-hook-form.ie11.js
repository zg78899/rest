                ...
                case 1:
                    ...
                    if (isArray(payload)) {
                        ...
                        error = (get(errors, fieldName)
                            ? (_a = {}, _a[fieldName] = get(errors, fieldName), _a) : {});
...
var Controller = function (_a) {
    var _b, _c, _d, _e, _f;
    var name = _a.name, rules = _a.rules, InnerComponent = _a.as, onChange = _a.onChange, onBlur = _a.onBlur, _g = _a.onChangeName, onChangeName = _g === void 0 ? VALIDATION_MODE.onChange : _g, _h = _a.onBlurName, onBlurName = _h === void 0 ? VALIDATION_MODE.onBlur : _h, valueName = _a.valueName, defaultValue = _a.defaultValue, control = _a.control, rest = __rest(_a, ["name", "rules", "as", "onChange", "onBlur", "onChangeName", "onBlurName", "valueName", "defaultValue", "control"]);
    var methods = useFormContext() || {};
    var _j = control || methods.control, defaultValues = _j.defaultValues, fields = _j.fields, setValue = _j.setValue, register = _j.register, unregister = _j.unregister, errors = _j.errors, _k = _j.mode, isOnSubmit = _k.isOnSubmit, isOnBlur = _k.isOnBlur, _l = _j.reValidateMode, isReValidateOnBlur = _l.isReValidateOnBlur, isReValidateOnSubmit = _l.isReValidateOnSubmit, isSubmitted = _j.formState.isSubmitted;
    var _m = __read(React.useState(isUndefined(defaultValue)
        ? isUndefined(defaultValues[name])
            ? ''
            : defaultValues[name]
        : defaultValue), 2), value = _m[0], setInputStateValue = _m[1];
    ...
    var props = __assign(__assign(__assign(__assign({}, rest), (onChange
        ? (_b = {}, _b[onChangeName] = eventWrapper(onChange, EVENTS.CHANGE), _b) : (_c = {}, _c[onChangeName] = handleChange, _c))), (isOnBlur || isReValidateOnBlur
        ? onBlur
            ? (_d = {}, _d[onBlurName] = eventWrapper(onBlur, EVENTS.BLUR), _d) : (_e = {}, _e[onBlurName] = handleBlur, _e)
        : {})), (_f = {}, _f[valueName || (isCheckboxInput ? 'checked' : VALUE)] = value, _f));
...
var ErrorMessage = function (_a) {
    var InnerComponent = _a.as, errorsFromProps = _a.errors, name = _a.name;
    var methods = useFormContext() || {};
    var message = get(errorsFromProps || methods.errors, name, {}).message;
    if (!message) {
        return null;
    }
    var props = { children: message };
    return InnerComponent ? (React.isValidElement(InnerComponent) ? (React.cloneElement(InnerComponent, props)) : (React.createElement(InnerComponent, __assign({}, props)))) : (React.createElement(React.Fragment, null, message));
};
